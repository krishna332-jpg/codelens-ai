    ...
    <div className="review-page">
      ...
      <div className="editor-wrapper">
        ...
        <textarea
          ...
          placeholder={'// Paste your ' + (currentLang ? currentLang.label : language) + ' code here...'}
          spellCheck={false}
        />
      </div>
      ...
      <div className="editor-footer">
        ...
        <button className="review-btn" onClick={handleReview} disabled={loading || !code.trim()}>
          {loading ? <span><span className="spinner" /> Analyzing...</span> : <span>Review Code <ArrowRightIcon /></span>}
        </button>
      </div>
    </div>
  );
