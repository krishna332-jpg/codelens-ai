...
const LockIcon = () => (
  <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{color:'#fff',marginBottom:'12px'}}>
      ...
      {!user ? (
        <div className="auth-wall">
          ...
          <div className="auth-wall-btns">
            <button className="nav-btn" onClick={onAuthRequired}>Get started free</button>
          </div>
        </div>
      ) : (
        <>
          <div className="editor-controls">
            <div className="lang-select-wrapper">
              {currentLang && (
                <img src={`/${currentLang.logo}`} alt={currentLang.label} className="lang-select-icon"
